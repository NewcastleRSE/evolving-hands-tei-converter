...
If the metadata about places is stored in a separate file, remember to add the [projectRoot](./../TeiConverter.config.md#projectroot) and the URL to the [places metadata file](./../TeiConverter.config.md#metadataseparateplaces).
