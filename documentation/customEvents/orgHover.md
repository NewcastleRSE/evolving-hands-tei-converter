...
If the metadata about organisations is stored in a separate file, remember to add the [projectRoot](./../TeiConverter.config.md#projectroot) to the config file.
